...
# Goto terminal or Command Prompt and change directory to the desktop (or where you want to clone the repo)
...
#ls to view all files of directory
#ls -al to view hiddem files
